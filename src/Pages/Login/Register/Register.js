...
export const Register = () => {
    ...
    async function onclick(e) {
        e.preventDefault()
        try {
            await axios.post('http://172.16.0.201:8080/user', { name: LoginData.name, username: LoginData.username, password: LoginData.password, role: LoginData.role }, { headers: headers })
